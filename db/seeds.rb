...
party2 = Party.new(user: jean, name: "Soirée barbeuc", address: "8 rue saint-maur Paris", date: "jeudi dans 2 semaines", available_seats: 4, description: "Petit barbeux tranquille", requirement: "viande, bières")
party2.save!
